...
for percentage in memory_percentages:
    ...
    file_name = f'{program_name}-{app_name1}-{percentage*10}%.py'
    ...
    with open(file_name, 'w') as script_file:
        ...
        script_file.write(f"  job_manifest = job_template.format(index=i, memory_request={memory_request}, memory_limit={memory_limit}, program_name=program_name, app_name1=app_name1, app_name2=app_name2)\n")
